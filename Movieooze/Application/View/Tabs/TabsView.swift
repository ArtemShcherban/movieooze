...
var collectionView: UICollectionView!
    ...
    private func createView() {
        ...
        NSLayoutConstraint.activate([self.collectionView.topAnchor.constraint(equalTo: self.topAnchor),
...
extension TabsView: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.tabViewModel = Tab(icon: tabs[indexPath.row].icon, title: tabs[indexPath.row].title)
...
extension TabsView: UICollectionViewDelegateFlowLayout {
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        ...
        case .scrollable:
            ...
            let tabTitle = tabs[indexPath.row].title
            
        // Add more space left and right the tab
            var addSpace: CGFloat = 90
            if tabs[indexPath.row].icon != nil {
                addSpace += 40
            }
