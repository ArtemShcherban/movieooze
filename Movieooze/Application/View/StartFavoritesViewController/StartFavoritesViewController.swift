//
//  StartFavoritesViewController.swift
//  Movieooze
//
//  Created by Artem Shcherban on 07.10.2021.
//

import Foundation
import UIKit

class StartFavoritesViewController: UIViewController {
    ...
    func showViewController(_ index: Int) -> UIViewController? {
       ...
       currentIndex = index
        ...
        if index == 0 {
            let contentVC = storyboard?.instantiateViewController(withIdentifier: FavoriteMovieViewController.reuseIdentifire) as! FavoriteMovieViewController
            contentVC.pageIndex = index
            return contentVC
            
        } else if index == 1 {
            let contentVC = storyboard?.instantiateViewController(withIdentifier: FavoriteTVShowViewController.reuseIdentifire) as! FavoriteTVShowViewController
        contentVC.pageIndex = index
        return contentVC
...
extension StartFavoritesViewController: TabsDelegate {
...
extension StartFavoritesViewController: UIPageViewControllerDataSource, UIPageViewControllerDelegate {
    ...
    func getVCPageIndex(_ viewController: UIViewController?) -> Int {
        ...
        case is FavoriteMovieViewController:
            let vc = viewController as! FavoriteMovieViewController
            return vc.pageIndex
        case is FavoriteTVShowViewController:
            let vc = viewController as! FavoriteTVShowViewController
            return vc.pageIndex
