...
//class MoviesForFavoritesRealm: Object {
//    @objc dynamic var adult = false
//    @objc dynamic var backdropPath = ""
//    @objc dynamic var budget = 0
//    @objc dynamic var genreIDFirst = 0
...
//    @objc dynamic var voteAverage = 0.0
//    @objc dynamic var voteCount = 0
//    @objc dynamic var videos : Videos?
//    @objc dynamic var images : Images?
//    @objc dynamic var credits : Credits?
//    @objc dynamic var productionCompanies : [ProductionCompanies]?
//    @objc dynamic var productionCountries : [ProductionCountries]?
//    @objc dynamic var spokenLanguages : [SpokenLanguages]?
//    @objc dynamic var belongsToCollection : BelongsToCollection?
//}
